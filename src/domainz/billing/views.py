...
from domainz.billing.forms import UpdateBillingInformationForm
from domainz.model_loaders import get_stripe_customer_model
...
def billing_settings_view(request):
    ...
    if request.method == "POST":
        if form.is_valid():
            ...
            return redirect("domainz-billing:billing-settings")
