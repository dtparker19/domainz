...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "domainz.context_processors.google_oauth_client_id",
                "domainz.context_processors.stripe_publishable_key",
            ],
        },
    },
]

WSGI_APPLICATION = "domainz.wsgi.application"
...
AUTH_USER_MODEL = "domainz_auth.User"
